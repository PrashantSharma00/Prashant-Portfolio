      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0 ">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Hi, I'm <span className="text-purple ">Prashant Sharma</span>
          </h1>
          <h2 className="text-2xl md:text-4xl font-semibold mb-6  typewriter">
            Frontend Developer 
          </h2>
          <p className="text-lg text-gray-300 mb-8 ">
            I specialize in building dynamic and interactive user interfaces
            using React and modern frontend tools.
          </p>
          <div className="flex space-x-4">
            <a
              href="#projects"
              className="px-6 py-3 bg-purple font-medium rounded-lg hover:text-purple-700 transition duration-300"
            >
              View Work
            </a>
            <a
