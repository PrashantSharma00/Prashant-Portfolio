          ...
          <div>
            <form className="space-y-6">
              ...
              <div>
                ...
                <button
                  type="submit"
                  className="px-6 py-3 w-full mt-3 bg-purple rounded-lg font-medium hover:bg-purple-700 transition duration-300 cursor-pointer "
                >
                  Send
                </button>
              </div>
            ...
            <div className="flex items-start ">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Mundawar, Dist : Khairthal-Tijara (Raj.)
                </p>
              </div>
            </div>
            <div className="flex items-start ">
              ...
              <div>
                ...
                <p className="text-gray-400">prsmdr04@gmail.com</p>
              </div>
            </div>
            <div className="flex items-start ">
              <div className="text-purple text-2xl mr-4 ">
              ...
              <div>
                ...
                <p className="text-gray-400">+91 6376465800</p>
              </div>
            </div>
            <div className="pt-4 ">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/PrashantSharma00"
                ...
                <a
                  href="https://www.linkedin.com/in/prashant-s-022508229"
